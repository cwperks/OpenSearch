 ...
 * @since 0.9
 */
public class OpenSearchWildcardPermission extends WildcardPermission {
     ...
     */
    protected OpenSearchWildcardPermission() {
    }

    public OpenSearchWildcardPermission(String wildcardString) {
        this(wildcardString, DEFAULT_CASE_SENSITIVE);
    }

    public OpenSearchWildcardPermission(String wildcardString, boolean caseSensitive) {
    ...
    public boolean implies(Permission p) {
        // By default only supports comparisons with other OpenSearchWildcardPermissions
        if (!(p instanceof WildcardPermission)) {
            return false;
        }

        WildcardPermission tmp = (WildcardPermission) p;
        OpenSearchWildcardPermission wp = new OpenSearchWildcardPermission(tmp.toString());
    ...
    public boolean equals(Object o) {
        if (o instanceof OpenSearchWildcardPermission) {
            OpenSearchWildcardPermission wp = (OpenSearchWildcardPermission) o;
